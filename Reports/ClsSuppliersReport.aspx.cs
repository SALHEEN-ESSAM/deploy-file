...
namespace Amana
{
    public partial class SuppliersReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                rvSiteMapping.LocalReport.ReportPath = Server.MapPath("~/Reports/ClsSuppliersReport.rdlc");
        ...
        private void LocalReport_SubreportProcessing(object sender, SubreportProcessingEventArgs e)
        {
            ...
            {
                var lst = new AmanaConcreteDBEntities1().FactoryMaterialSuppliers.Include(a => a.IdxMaterialTypes).Where(a => a.FactoryId == ID).ToList();
